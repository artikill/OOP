...
public class Task5 {
   ...
   /*8. Хеш-алгоритмы легко сделать одним способом, но по существу невозможно
    ...
    public static void main(String[] args) throws NoSuchAlgorithmException {
        ...
        int[] var10001 = new int[]{72, 33, -73, 84, -12, -3, 13, -13, -68};
        System.out.println("№ 1.2 " + dycrypt(var10001));
        System.out.println("№ 2 " + canMove("Rook", "A8", "H8"));
        System.out.println("№ 3 " + canComplite("buthl", "beautiful"));
        var10001 = new int[]{1, 2, 3, 4, 5, 6};
        System.out.println("№ 4 " + sumDigProd(var10001));
        PrintStream var10000 = System.out;
        String[] var1 = new String[]{"toe", "ocelot", "maniac"};
        var10000.println("№ 5 " + sameVowelGroup(var1));
